...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log("Details are: ", { name, email, password });
    ...
    <div>
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="name" name='name' value={credentials.name} onChange={onChange} aria-describedby="emailHelp" required minLength={5}/>
        </div>
        <div className="mb-3">
